...
echo_and_run cd "/home/nadoud/inmoov/src/ros_control-kinetic-devel/controller_manager_tests"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nadoud/inmoov/src/ros_control-kinetic-devel/controller_manager_tests/setup.py" \
     \
    build --build-base "/home/nadoud/inmoov/build/ros_control-kinetic-devel/controller_manager_tests" \
    install \
    --root="${DESTDIR-/}" \
