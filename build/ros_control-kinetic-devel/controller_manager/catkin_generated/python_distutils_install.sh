...
echo_and_run cd "/home/nadoud/inmoov/src/ros_control-kinetic-devel/controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nadoud/inmoov/src/ros_control-kinetic-devel/controller_manager/setup.py" \
     \
    build --build-base "/home/nadoud/inmoov/build/ros_control-kinetic-devel/controller_manager" \
    install \
    --root="${DESTDIR-/}" \
