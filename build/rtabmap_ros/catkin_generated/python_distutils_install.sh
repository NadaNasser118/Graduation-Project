...
echo_and_run cd "/home/nadoud/inmoov/src/rtabmap_ros"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nadoud/inmoov/src/rtabmap_ros/setup.py" \
    egg_info --egg-base /home/nadoud/inmoov/build/rtabmap_ros \
    build --build-base "/home/nadoud/inmoov/build/rtabmap_ros" \
    install \
    --root="${DESTDIR-/}" \
